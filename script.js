document.querySelector("form").addEventListener("submit", async function (event) {
    ...
    try {
        ...
        const servidorSelecionado = document.querySelector('input[name="servidor"]:checked').value;
...
async function enviarRequisicao(servidor, entrada, baseOrigem, baseFinal) {

    // escolhe a porta conforme o rádio selecionado
    let url;

    if (servidor === "typescript") {
